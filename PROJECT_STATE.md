...
- Phase B (EKS-adapt) — B1 cert-manager (7) + B2 external-secrets (7) + B3 prometheus (6) + B4 otel-collector (6)
- **Total: 111 static tests green. Live tests skip cleanly when
